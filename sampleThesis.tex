...
As we have discussed in the introduction (\ref{sec:philo}), the extraction of mutation signatures can be seen as finding latent themes from a collection of samples each represented as counts of variants of distinct classes. There are multiple challenges before a systematic discovery of SV signatures
