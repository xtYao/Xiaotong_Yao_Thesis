...
\begin{figure}
    ...
    \caption{\textbf{\textit{NRG1} mutations in RPA(-) versus RPA(+).}}{}
...
\begin{figure}
    ...
    \caption{\textbf{Promoter mutations and amplifications both increase \textit{\textit{ILF2}} expression compared to wildtype.}}{}
...
\begin{figure} 
    ...
    \caption{\textbf{Mutations around 10kb window from the \textit{ILF2} promoter peak.}}
