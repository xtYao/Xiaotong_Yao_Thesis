...
Genomic instability is a hallmark of cancer \cite{Hanahan2011-ni} and numerous studies have proved the ubiquity of genomic variants in all cancer tissues \cite{pcawg_marker2020-yi}. The reportoire of variants in cancer genomes are shaped by various mutagenesis pathways, repair, and somatic evolution. The goal of studying patterns of genomic variants is to find generic patterns out of large panels of tumor variant profiles, infer possible mechanisms from which specific variants arise, and ultimately understand  etiology.

Even though the idea that abnormal chromosomes as an intrinsic property of cancers has been proposed \cite{Boveri2008-rl} and verified for more than a century, the usage of massively parallel sequencing in the past decade has been revolutionary in the characterization of a much bigger reportoire of SV events in unprecedented details. Enrichment for specific DNA sequences for sequencing, including gene panels and whole exome sequencing (WES), are done routinely in many clinical settings. While less widely used in clinic due to higher cost and more difficult analysis, whole genome sequencing (WGS) provides a hollistic profile of all single nucleotide variants (SNV), small insertions and deletions (INDEL), and structural variants (SV), thanks to the unbiased sampling of DNA fragments over the whole genome. There is little doubt that more WGS data and more sophiticated analyses will largely improve our understanding of the origin of cancer.
...
% large numbers of cancer genomes revealing ubiquitous yet heterogeneous patterns of
