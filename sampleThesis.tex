...
% Text in figure is too small; all lettering must be readable even when reduced 25%, including axes and legends. Please enlarge the text/figure to make the text readable. Alternatively, you can separate and enlarge portions of the figures, rotate them 90 degrees, or adjust the background color for better contrast. Please see guidelines if the figure takes up or exceeds a single page. (Figures 2.3 (done), 2.11 (done), 3.20 (done), 4.1, 4.2, 4.12, 5.3, 5.4, 5.22
...
%             \end{minipage},rotate=90,center}
%     \includegraphics[height=0.95\textheight]{figures/600ppi/ggjs.png}            
%     \label{fig:ggjs}
%     \end{adjustbox}
% \end{figure}    
