...
\begin{figure}[h!]
    ...
    \caption{\textbf{Schematic of a genome graph.}}{}
...
\begin{figure}[h!]
    ...
    \caption{\textbf{A snapshot of the gGnome.js interface of a BFB cycles event in an esophageal adenocarcinoma sample.}}{}
    \label{fig:ggjs}
\end{figure}
% 
