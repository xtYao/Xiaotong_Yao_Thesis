...
\begin{figure*}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/600ppi/variant_subgraph.png}
...
Analyzing junction-balanced genome graph topology, we identified subgraphs associated with previously identified complex rearrangement patterns such as chromothripsis, chromoplexy, and TICs (Figure \ref{fig:}) implementing criteria described in previous publications within our framework (see \nameref{app:a}).
