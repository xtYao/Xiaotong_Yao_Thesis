...
% intro: define biological/technical questions
% -- gGnome: current SV analysis limited by lack of a representation of complex SVs and a set of practical tools
% -- JaBbA: a reliable, high-fidelity method to infer JBGG from WGS is needed
% -- Distinct SV classes: analyzing JCN topography lead to new SV patterns
% -- Telomere: no answer to what SVs are the direct result of crisis
% -- LUAD: can WGS find new drivers after WES defined RPAs

% Discussion:
% -- gGnome fulfills the need for analyzing complex SVs
% -- JaBbA provides a viable option to scale up genome graph analysis
% -- Tyfonas emerge from high JCN subgraphs and distinct from DM/BFB
% -- SV patterns can stratify pan-cancer cohort
% -- TC: both simple & complex observed in previous models
% -- TC: MRC5 model after crisis show instability triggered by shortest telomere and result in diverging & converging patterns of SVs
% -- LUAD: nominating alternative SV drivers, recurrent non-coding mutations, non-canonical coding mutations, missed RPAs when no known RPA is found by WES
